    ...
    is_expected.to eq(
      [
        ...
        },
        {
          email:        nil,
          employee_id:  '2',
          submitted_at: '2018-08-17T07:05:41+00:00',
          answers:      ['4', '5', '5', '3', '3']
        },
        {
          email:        nil,
          employee_id:  '3',
          submitted_at: '2018-08-17T17:35:41+00:00',
          answers:      ['5', '5', '5', '5', '4']
        },
        {
          email:        'employee4@abc.xyz',
          employee_id:  '4',
          submitted_at: '2018-08-17T04:05:41+00:00',
          answers:      ['5', '5', '5', '4', '4']
        },
        {
          email:        nil,
          employee_id:  '5',
          submitted_at: '2018-08-17T11:35:41+00:00',
          answers:      ['4', '5', '5', '2', '3']
        },
        {
